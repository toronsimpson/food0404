...
public class PolicyHandler {
    ...
    @StreamListener(
        value = KafkaProcessor.INPUT,
        condition = "headers['type']=='DeliveryConfirmeds'"
    )
    public void wheneverDeliveryConfirmeds_UpdateStatus(
        @Payload DeliveryConfirmeds deliveryConfirmeds
    ) {
        DeliveryConfirmeds event = deliveryConfirmeds;
        System.out.println(
            "\n\n##### listener UpdateStatus : " + deliveryConfirmeds + "\n\n"
        );
